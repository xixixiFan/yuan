<template>
  <div :class="['yuan-optfile-default',customClass]">
    <input type="file" :accept="accept" :multiple="multiple" @change="testchange" hidden ref="refInp">
    <div class="yuan-preview-img-box">
      <transition-group name="list-img">
        <template  v-if="targetType=='box'&&imgListShow&&!showFileList">
          <div class="yuan-preview-img-img" v-for="(item,index) in File" :key="index">
            <div class="yuan-previre-img-actions">
      ...
      <div :class="['yuan-optfie-area',{'yuan-optfie-area-big':size=='big','yuan-opfile-area-active':activeFile}]" v-if="targetType=='box'" ref="refDiv">
        <div class="yuan-optfile-area-text" @click="changeFile">
          <div class="yuan-optfile-text-pos">
    ...
    <!-- <img :src="imgSrc" alt=""> -->
    <div class="yuan-optfile-filelist" v-if="FileList.length>0&&showFileList">
      <ul>
...
.yuan-optfile-default{
  width: 100%;
  height: auto;
  overflow: hidden;
  .yuan-preview-img-box{
    width:auto;
    height:auto;
    overflow: hidden;
    .yuan-preview-img-img{
      width:130px;
      height:130px;
      float: left;
      margin:0 4px;
    ...
    .yuan-opfile-area-active{
      transition: all .4s;
      border-color:#0e80eb ;
    }
  }
  .yuan-optfile-filelist{
      width: 100%;
      height: auto;
      overflow: hidden;
      margin-top:2px;
