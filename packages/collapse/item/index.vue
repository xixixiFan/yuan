<template>
  <div class="yuan-default-collapse-item-box">
    <div class="yuan-collapse-item-title"  @click="togger(this)">
      <span>标题</span>
      <i class="m-icon-arrow-right" :class="{rotate:boxshow}"></i>
    </div>
     <!-- v-show="boxshow" -->
    <transition name="slide-fade">
      <div class="yuan-collapse-slot-box" v-show="boxshow">
        <div class="yuan-slot-item-box">
          <slot></slot>
        </div>
      </div>
    </transition>
...
.yuan-default-collapse-item-box{
  height:auto;
  
  .yuan-collapse-item-title{
    width:100%;
    height:40px;
    padding:0 10px;
