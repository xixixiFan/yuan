...
.popover-box .popover-box-content {
  overflow: auto;
}
.popover-box .popover-box-content .popover-title {
  color: #303133;
  font-size: 16px;
  line-height: 1;
  margin-bottom: 12px;
...
.popover-box .top-start {
  bottom: 100%;
  left: 0;
  margin-bottom: 12px;
}
.popover-box .top-start .popover-arrow {
  position: absolute;
  top: 100%;
...
.popover-box .top-end .popover-arrow {
  position: absolute;
  top: 100%;
...
.popover-box .bottom .popover-arrow {
  position: absolute;
  bottom: 100%;
  left: 50%;
  content: "";
...
.popover-box .bottom-start {
  top: 100%;
  left: 0;
  margin-top: 12px;
}
.popover-box .bottom-start .popover-arrow {
  position: absolute;
  bottom: 100%;
  left: var(--geticonsite);
  content: "";
...
.popover-box .bottom-end {
  top: 100%;
  right: 0;
  margin-top: 12px;
}
.popover-box .bottom-end .popover-arrow {
  position: absolute;
  bottom: 100%;
  right: var(--geticonsite);
  content: "";
...
.popover-box .left .popover-arrow {
  position: absolute;
  left: 100%;
  top: 50%;
  content: "";
...
.popover-box .left-start {
  right: 100%;
  background-color: #ffffff;
  top: 0;
  margin-right: 12px;
}
.popover-box .left-start .popover-arrow {
  position: absolute;
  left: 100%;
  top: var(--geticonsite);
  content: "";
...
.popover-box .left-end {
  right: 100%;
  background-color: #ffffff;
  bottom: 0;
  margin-right: 12px;
}
.popover-box .left-end .popover-arrow {
  position: absolute;
  left: 100%;
...
.popover-box .right .popover-arrow {
  position: absolute;
  right: 100%;
  top: 50%;
  content: "";
...
.popover-box .right-start {
  --geticonsite: 0;
  left: 100%;
  top: 0;
  margin-left: 12px;
}
.popover-box .right-start .popover-arrow {
  position: absolute;
  right: 100%;
  top: var(--geticonsite);
  content: "";
...
.popover-box .right-end {
  left: 100%;
  bottom: 0;
  margin-left: 12px;
}
.popover-box .right-end .popover-arrow {
  position: absolute;
  right: 100%;
  bottom: var(--geticonsite);
  content: "";
