<template>
  <transition name="fade">
    <div :class="['yuan-backtop-box',customClass]" v-if="backtopShow" @click="backtop">
      <slot v-if="slot['default']"></slot>
      <div class="yuan-backtop-default-box" v-else>
...
.yuan-backtop-box,.yuan-backtop-default-box{
  width: auto;
  overflow: auto;
  position: fixed;
