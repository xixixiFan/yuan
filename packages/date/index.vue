<template>
  <div :class="['yuan-date-box','yuan-date-default']" v-click-outside>
    <div class="yuan-date-inner-box">
      ...
      <transition name="slide-fade">
        <div :class="['yuan-date-option',`yuan-date-option-${size}`,customClass]" v-if="show">
          <div class="yuan-date-fipx-box">
            <!-- 年月日 -->
            <div class="yuan-date-date-box">
              <div :class="['yuan-date-header',`yuan-date-header-${size}`]">
                <div class="yuan-date-btn-left">
                  ...
                  <span v-if="dateShow&&type=='date'" class="yuan-i-rotate"><i class="m-icon-arrow-right" @click="prevMonth"></i></span>
                </div>
                <div class="yuan-date-btn-center">
              ...
              <div :class="['yuan-date-content-box',`yuan-date-content-box-${size}`]" v-show="dateShow&&type=='date'">
                <div class="yuan-date-year-month-box">
                  <table>
                    <tbody>
                      <tr>
                        <th><span>一</span></th>
                ...
                <div class="yuan-today-box" v-if="showToday&&type=='date'"><span @click="today" class="yuan-today-span">今天</span></div>
              </div>
              <!-- year -->
              <div :class="['yuan-choose-year-box',`yuan-choose-year-box-${size}`]" v-show="!dateShow&&!monthShow
              ||type=='year'">
                <div v-for="(item,index) in yearList" :key="index">
                  <span :class="[{'active':selDate.year==item},'yuan-chooseYear-span']" @click="dateYearSel(item)">{{item}}</span>
                </div>
              </div>
              <!-- months -->
              <div :class="['yuan-choose-month-box',`yuan-choose-month-box-${size}`]" v-show="monthShow">
                <div v-for="(item,index) in monthList" :key="index">
                  <span :class="[{'active':selDate.month==item.m1},'yuan-chooseMonth-span']" @click="dateMonthSel(item)">{{item.m}}</span>
                </div>
              </div>
            </div>
          </div>
...
.yuan-date-box,.yuan-date-default{
  width: 200px;
  ...
  .yuan-date-inner-box{
    width: 100%;
		height: auto;
		position: relative;
    .yuan-date-option,.yuan-date-option-default{
      width: 160%;
		  height: auto;
      position: absolute;
      bottom:0;
  ...
  .yuan-date-header,.yuan-date-header-default{
    width: 100%;
    height:38px;
  ...
  .yuan-date-content-box,.yuan-date-content-box-default{
    width: 100%;
    height:auto;
    overflow: hidden;
    padding:0 10px;
    box-sizing: border-box;
    .yuan-date-year-month-box{
      width:100%;
      height:auto;
      overflow: hidden;
      padding-bottom: 10px;
  ...
  .yuan-choose-year-box,.yuan-choose-year-box-default{
    width:100%;
    height:auto;
    overflow: hidden;
    padding:20px 10px;
  ...
  .yuan-choose-month-box,.yuan-choose-month-box-default{
     width:100%;
    height:auto;
    overflow: hidden;
    padding:20px 10px;
