<template>
  <transition name="fade">
    <div v-if="isShow" ref="colorPicker" :class="['yuan-color-picker', customClass]">
      <!-- 显示颜色的小方块 -->
      <div class="yuan-color-picker-hd">
        <span class="hd-color-preview"></span>
        <span class="default-color-text" @click="setColor(props.defaultColor)">默认颜色</span>
      </div>
      <div class="yuan-color-picker-bd">
        <p>主题颜色</p>
        <ul class="t-color">
          <li
