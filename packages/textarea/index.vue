<template>
  <div :class="['yuan-textarea-default',customClass,{'yuan-textarea-disabled':disabled}]">
    <textarea :form="form" :cols="cols" :rows="rows" :placeholder="placeholder" :maxlength="maxlength" :value="modelValue" @input="input" ref="textareayuan" :disabled="disabled" :style="tStyle" @focus="focus" @blur="blur" :readonly="readonly"></textarea>
