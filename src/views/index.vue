...
const features = ref([
  {
    title: "更小的体积",
    description: "组件体积更小，灵活使用，按需使用。",
    icon: "📦"
  },
  {
    title: "更快的响应",
    description: "配合Vue 3的Composition API，更快的响应速度。",
    icon: "⚡"
  },
  {
    title: "更强的拓展性",
    description: "给开发者几乎所有的机会来自定义组件，满足一切项目使用场景。",
    icon: "🔧"
  },
  {
    title: "更完美的支持",
    description: "专为Vue 3版本开发，充分利用Vue 3的新特性。",
    icon: "✅"
  },
  {
    title: "更友好的渲染",
...
.hero-content, .hero-image, .feature-card, .component-card {
